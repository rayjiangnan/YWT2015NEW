...
@property (weak, nonatomic) IBOutlet UILabel *CertifyCompanyName;

@property (weak, nonatomic) IBOutlet UIImageView *e_fr_sfzzm;
@property (weak, nonatomic) IBOutlet UIImageView *e_fr_sfzfm;
@property (weak, nonatomic) IBOutlet UIImageView *e_ylzz;
...
@implementation RenzhenItemCompany
@synthesize UserID;
...
-(void) LoadItem
{
    ...
    [op setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([Status isEqualToString:@"0"]){
            ...
            self.CertifyCompanyName.text= [NSString stringWithFormat:@"%@",dict2[@"CertifyCompanyName"]];
...
-(void) ShowImg:(NSString *) imgpath showType:(NSString *) mType
{
    ...
    if ([mType isEqualToString:@"e_fr_sfzzm"]) {
        [self.e_fr_sfzzm setImageWithURL:imgurl placeholderImage:[UIImage imageNamed:imgpath]];
    }
    else  if ([mType isEqualToString:@"e_fr_sfzfm"]) {
        [self.e_fr_sfzfm setImageWithURL:imgurl placeholderImage:[UIImage imageNamed:imgpath]];
    }
    else  if ([mType isEqualToString:@"e_ylzz"]) {
        [self.e_ylzz setImageWithURL:imgurl placeholderImage:[UIImage imageNamed:imgpath]];
    }
}
