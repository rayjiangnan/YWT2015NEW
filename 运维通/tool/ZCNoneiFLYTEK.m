...
-(void)playVoice:(NSString*)str{
    ...
    [iFlySpeechSynthesizer setParameter:@"volume" value:@"80"];//合成的音量;取值范围 0~100
...
-(void)discernBlock:(void(^)(NSString*))a{
    ...
    iflySpeechRecognizer = [IFlySpeechRecognizer createRecognizer: @"appid=52bbb432,timeout=8000" delegate:self];//时间按照毫秒计算
